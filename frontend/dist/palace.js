...
(function (ANIMATION_ID) {
    ...
    ANIMATION_ID[ANIMATION_ID["character_left_to_right_move"] = 5] = "character_left_to_right_move";
...
const moveCamera = () => {
    ...
    MAPS.forEach(map => map.style.left = `${map.offsetLeft - 4}px`);
...
const launchAttack = () => {
    ...
    setTimeout(() => launchAnimationAndDeclareItLaunched(heroImage, 0, 'png', 'assets/challenge/characters/hero/run', 1, 8, 1, true, ANIMATION_ID.run), 1000);
};
